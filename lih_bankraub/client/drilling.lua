Scaleforms = exports["lih_scaleforms"]:Scaleforms()
...
AddEventHandler('lih_bankrobbery:drilling:start', Drilling.Start)
AddEventHandler('lih_bankrobbery:drilling:stop', Drilling.Stop)
